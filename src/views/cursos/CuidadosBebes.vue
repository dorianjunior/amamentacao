<template>
  <div class="cuidados-bebes-page">
    <!-- Hero Section -->
    <section class="hero-section">
      <div class="hero-background">
        <img src="/src/assets/img/servicos/home-care-materno-banner.webp" alt="Curso de Cuidados com Bebês">
      </div>
      <div class="hero-overlay"></div>
      <div class="hero-content">
        <div class="hero-badge" data-aos="fade-down">
          <i class="fas fa-baby"></i>
          <span>Curso Prático</span>
        </div>
        <h1 data-aos="fade-up" data-aos-delay="200">Curso de Cuidados com Bebês</h1>
        ...
        <div class="info-content" data-aos="fade-up">
          ...
          <div class="info-grid">
            <div class="info-item" data-aos="fade-up" data-aos-delay="100">
              ...
              <p>31 de agosto de 2025<br>08:00 às 13:00</p>
            </div>
