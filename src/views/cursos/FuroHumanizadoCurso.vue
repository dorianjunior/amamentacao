<template>
  <div class="furo-humanizado-page">
    <!-- Hero Section -->
    <section class="hero-section">
      <div class="hero-background">
        <img src="/src/assets/img/servicos/furo-humanizado.webp" alt="Curso de Furo Humanizado">
      </div>
      <div class="hero-overlay"></div>
      <div class="hero-content">
        <div class="hero-badge" data-aos="fade-down">
          <i class="fas fa-heart"></i>
          <span>Curso Especializado</span>
        </div>
        <h1 data-aos="fade-up" data-aos-delay="200">Curso de Furo Humanizado - Bebê e Adulto</h1>
        <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="300">31 de agosto de 2025</p>
        <div class="hero-details" data-aos="fade-up" data-aos-delay="400">
          ...
          <div class="detail-item">
            ...
            <span>Bebês e Adultos</span>
          </div>
        </div>
        <a href="https://wa.me/5548996680096?text=Olá! Gostaria de me inscrever no Curso de Furo Humanizado" 
           target="_blank" 
           class="hero-cta" 
           data-aos="zoom-in" 
           data-aos-delay="500">
        ...
        <div class="info-content" data-aos="fade-up">
          ...
          <div class="info-grid">
            <div class="info-item" data-aos="fade-up" data-aos-delay="100">
              ...
              <p>31 de agosto de 2025<br>13:00 às 20:00</p>
            </div>
        ...
        <div class="contact-content">
          ...
          <div class="contact-cta" data-aos="fade-left">
            <div class="cta-card">
              ...
              <p>Garante sua vaga no Curso de Furo Humanizado</p>
              <a href="https://wa.me/5548996680096?text=Olá! Gostaria de me inscrever no Curso de Furo Humanizado" 
                 target="_blank" 
                 class="whatsapp-cta">
                <i class="fab fa-whatsapp"></i>
